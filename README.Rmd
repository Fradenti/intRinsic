...
Please note that the previous versions of the package (from `v0.1.0` to `v1.0.2`) are still available as GitHub Releases at [this page](https://github.com/Fradenti/intRinsic/releases).
